...
<tr><td><b>Id</b></td><td><CopyableCode code="kafka.share_group.consumers" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_kafka_share_group_consumer"
    values={[
        { label: 'get_kafka_share_group_consumer', value: 'get_kafka_share_group_consumer' },
        { label: 'list_kafka_share_group_consumers', value: 'list_kafka_share_group_consumers' }
    ]}
>
<TabItem value="get_kafka_share_group_consumer">
...
<TabItem value="list_kafka_share_group_consumers">
...
<tbody>
<tr>
    <td><a href="#get_kafka_share_group_consumer"><CopyableCode code="get_kafka_share_group_consumer" /></a></td>
...
<tr>
    <td><a href="#list_kafka_share_group_consumers"><CopyableCode code="list_kafka_share_group_consumers" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td></td>
    <td>Return a list of consumers that belong to the specified share<br />group.</td>
</tr>
</tbody>
</table>
...
kind,
metadata
FROM kafka.share_group.consumers
...
Return a list of consumers that belong to the specified share<br />group.
