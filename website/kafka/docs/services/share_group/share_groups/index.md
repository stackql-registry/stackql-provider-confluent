...
Creates, updates, deletes, gets or lists a <code>share_groups</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="share_groups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="kafka.share_group.share_groups" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_kafka_share_group"
    values={[
        { label: 'get_kafka_share_group', value: 'get_kafka_share_group' },
        { label: 'list_kafka_share_groups', value: 'list_kafka_share_groups' }
    ]}
>
<TabItem value="get_kafka_share_group">
...
<tr>
    <td><CopyableCode code="share_group_id" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
<tr>
    <td><CopyableCode code="assigned_topic_partitions" /></td>
    <td><code>array</code></td>
    <td>List of topic-partitions assigned to this share group, including those from empty groups</td>
</tr>
<tr>
    <td><CopyableCode code="consumer_count" /></td>
    <td><code>integer (int32)</code></td>
    <td>Number of consumers in this share group</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>integer (int32)</code></td>
    <td>Total number of partitions assigned to this share group across all consumers</td>
</tr>
<tr>
...
<TabItem value="list_kafka_share_groups">
...
partition_count,
state
FROM kafka.share_group.share_groups
...
Return the list of share groups that belong to the specified<br />Kafka cluster.
...
<Tabs
    defaultValue="delete_kafka_share_group"
    values={[
        { label: 'delete_kafka_share_group', value: 'delete_kafka_share_group' }
    ]}
>
<TabItem value="delete_kafka_share_group">

Delete the share group specified by the ``group_id``.

```sql
DELETE FROM kafka.share_group.share_groups
WHERE cluster_id = '{{ cluster_id }}' --required
AND group_id = '{{ group_id }}' --required
AND kafka_endpoint_id = '{{ kafka_endpoint_id }}' --required
AND region = '{{ region }}' --required
