...
For control-plane operations (org, environments, IAM, managed cluster lifecycle, schema registry control, connectors, Flink, networking, billing), see the [`confluent`](/providers/confluent) provider.
